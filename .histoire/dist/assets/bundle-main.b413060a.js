...
var BaseListItemLink = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render]]);
...
const _hoisted_2$8 = { class: "htw-truncate" };
const _hoisted_3$6 = {
  key: 0,
          ...
          default: withCtx(({ active }) => {
            ...
            return [
              createBaseVNode("span", _hoisted_1$c, [
                ...
                createBaseVNode("span", _hoisted_2$8, toDisplayString(__props.story.title), 1)
              ]),
...
var StoryListItem = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-d0757d50"]]);
const base = "/";
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.6a22528e.js"), true ? ["assets/HomeView.6a22528e.js","assets/GenericMountStory.fe5a13ff.js","assets/vendor.18bd7c13.js"] : void 0)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.929bdb52.js"), true ? ["assets/StoryView.929bdb52.js","assets/vendor.18bd7c13.js","assets/BaseEmpty.aa8a83e2.js","assets/state.45f27d49.js","assets/GenericMountStory.fe5a13ff.js"] : void 0)
    }
  ]
});
...
var StoryListFolder = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-8eb31f6a"]]);
const _hoisted_1$a = {
...
var BaseSplitPane = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-328ea07c"]]);
...
const _hoisted_2$5 = { class: "htw-py-3 sm:htw-py-4 htw-flex-1 htw-h-full htw-flex htw-items-center htw-pr-2" };
...
const _hoisted_2$4 = { class: "htw-p-4 htw-h-16 htw-flex htw-border-b htw-border-gray-100 dark:htw-border-gray-800 htw-items-center htw-place-content-between" };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const SearchPane = defineAsyncComponent({
      loader: () => __vitePreload(() => import("./SearchPane.47e326d6.js"), true ? ["assets/SearchPane.47e326d6.js","assets/GenericMountStory.fe5a13ff.js","assets/vendor.18bd7c13.js","assets/BaseEmpty.aa8a83e2.js"] : void 0),
